...
US Letter:
python3 gen_pattern.py -o chessboard.svg --rows 9 --columns 6 --type checkerboard --square_size 30 -u mm -w 216 -h 279

python3 gen_pattern.py -o out.svg -r 11 -c 8 -T circles -s 20.0 -R 5.0 -u mm -w 216 -h 279
