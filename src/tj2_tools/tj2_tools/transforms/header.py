...
from tj2_tools.transforms.context_sequence_counter import ContextSequenceCounter
...
class Header:
    ...
    def to_msg(self) -> RosHeader:
        return RosHeader(stamp=rospy.Time(self.stamp), frame_id=self.frame_id, seq=self.seq)  # type: ignore
