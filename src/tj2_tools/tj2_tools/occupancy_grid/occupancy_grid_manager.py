...
class OccupancyGridManager:
    ...
    def set_scale(self, scale):
        ...
        self.grid_data = cv2.resize(
            self.grid_data, dsize=(self.map_config["width"], self.map_config["height"]), interpolation=cv2.INTER_NEAREST
        )
    ...
    def get_closest_cell_under_cost(self, x, y, cost_threshold, max_radius):
        ...
        """
        return self._get_closest_cell_arbitrary_cost(x, y, cost_threshold, max_radius, bigger_than=False)
    ...
    def get_closest_cell_over_cost(self, x, y, cost_threshold, max_radius):
        ...
        :param max_radius int: maximum number of cells around to check
        """
        return self._get_closest_cell_arbitrary_cost(x, y, cost_threshold, max_radius, bigger_than=True)

    def _get_closest_cell_arbitrary_cost(self, x, y, cost_threshold, max_radius, bigger_than=False):
