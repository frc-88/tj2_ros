MODEL_DIR=/home/ben/object-recognition/jetson_inference_training/detection/ssd/models/tj2_2020_game
...
/usr/bin/python3 /home/ben/object-recognition/jetson_inference_training/detection/ssd/onnx_export.py \
        --net=$BASE_NET \
        --model-dir=$MODEL_DIR \
        --input=$MODEL_NAME \
        --output=$OUTPUT
