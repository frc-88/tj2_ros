...
std_msgs::ColorRGBA TJ2Yolo::get_detection_color(cv::Mat color_cv_image, vision_msgs::Detection2D detection_2d_msg)
{
...
double TJ2Yolo::get_depth_from_detection(cv::Mat depth_cv_image, vision_msgs::Detection2D detection_2d_msg)
{
...
vision_msgs::Detection3D TJ2Yolo::detection_2d_to_3d(vision_msgs::Detection2D detection_2d_msg, double z_dist)
{
    int center_x = (int)(detection_2d_msg.bbox.center.x);
    int center_y = (int)(detection_2d_msg.bbox.center.y);
...
void TJ2Yolo::draw_overlay(cv::Mat img, const std::vector<std::vector<Detection>>& detections, bool label)
{
    if (detections.empty()) {
        return;
    }
