...
class Tester:
    def __init__(self) -> None:
        ...
        annotations_path = "/root/tj2_ros/dataset_builder/data/charged_up_2023/game_pieces/labels/test"
        images_path = "/root/tj2_ros/dataset_builder/data/charged_up_2023/game_pieces/images/test"
        self.frames = []
