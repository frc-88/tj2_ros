...
assert(iou_pos_sample_thresh > iou_reg_sample_thresh and iou_reg_sample_thresh > iou_neg_sample_thresh)
assert(roi_iou_pos_thresh > roi_iou_reg_thresh and roi_iou_reg_thresh > roi_iou_neg_thresh)
'''
...
roi_score_th = 0.5 # # after the roi, know whether it's an object. Only used in test mode.

roi_align_h, roi_align_w = 20, 20

neg_overlap_ratio = 0.2 # ensure a certain amount of overlapped neg samples for detection
