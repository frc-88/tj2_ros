...
class SSHTailer(object):
    ...
    def connect(self):
        ...
        if self.private_key:
            ...
            self.client.connect(self.host, username=self.username, password='', allow_agent=False, look_for_keys=False)
...
class SSHMultiTailer(object):
    ...
    def connect(self):
        ...
        for host, files in self.host_files.items():
            self.tailers[host] = {}
            for f in files:
    ...
    def tail(self, report_sleep=False):
        ...
        try:
            ...
            while 1:
                ...
                for host, tailers in self.tailers.items():
                    for filename, tailer in tailers.items():
